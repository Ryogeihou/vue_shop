<template>
  <div>
    ...
    <el-card>
      ...
      >
        ...
        >
          ...
          <el-tab-pane label="商品参数sku" name="1">
            <el-form-item
          ...
          <el-tab-pane label="商品属性spu" name="2">
            <el-form-item
              :label="item.attr_name"
    ...
    <el-dialog title="图片预览" :visible.sync="previewVisiblawe" width="50%">
...
export default {
  data () {
    return {
      ...
      fileList: [],
      //   uploadURL后如无upload则返回404
      headerObj: {
        Authorization: window.sessionStorage.getItem('token')
      },
      previewPath: '',
      previewVisiblawe: false
    }
  },
  created () {
    this.getCateList()
